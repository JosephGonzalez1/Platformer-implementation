class Platformer extends Phaser.Scene {
    ...
    init() {
        ...
        this.physics.world.gravity.y = 1850;
    ...
    create() {
        ...
        // Starting text
        my.text.start = this.add.bitmapText(10, 5, "rocketSquare", "Collect all of the coins to win!");

        // Create a new tilemap game object which uses 18x18 pixel tiles, and is
        // 45 tiles wide and 25 tiles tall.
        this.map = this.add.tilemap("platformer-level-1", 18, 18, 144, 25);
        this.physics.world.setBounds(0,0, 144*18 , 25*18);
    ...
    update() {
        ...
        if(this.coinGet == 0){
            this.add.text(2413, 216, "You Won! Press R to play again!", 20).setOrigin(0.5);
        }
    }
}
